...
if(isset($_POST['submit'])){
    $m_email = $_SESSION['membre_email'];
    $old_pass = $_POST['old_pass'];
    $new_pass = $_POST['new_pass'];
    $new_pass_again = $_POST['new_pass_again'];
    $sel_old_pass = "select * from membre where membre_pass='$old_pass'";
...
$update_pass = "update membre set membre_pass='$new_pass' where membre_email='$m_email'";
